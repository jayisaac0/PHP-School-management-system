            ...
            <?php
                ...
                foreach ($employees as $employees) {
                    ...
                    <tr>
                        ...
                        <td><a>Teacher</a></td>
                        <td>
                        <a>(responsibility)</a></td>
                        <td><a href="index/assign/<?php echo $employees->employeeid; ?>"><button type="button" class="btn btn-info btn-xs">Assign responsibility</button></a></td>
                    </tr>                    
                    <?php
                }
            ?>
