...
<div class="x_title">
    <h1><i class="fa fa-plus"> </i> Add Employee</h1>
...
<div class="x_panel">
    ...
    <div class="x_content">
        ...
        <?php require_once 'includes/controllers/insert/addemployee.php'; ?>  
        <form id="demo-form2" method="POST" data-parsley-validate class="form-horizontal form-label-left">
            ...
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="text" id="employeeid" name="employeeid" required="required" placeholder="Enter Title" class="form-control col-md-6 col-xs-12 " value="<?php echo time(); ?>" />
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <select class="select2_single form-control" id="classname" name="classname"  required="required" tabindex="-1">
